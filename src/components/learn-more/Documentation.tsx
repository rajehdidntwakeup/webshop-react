              ...
              <ol className="space-y-3">
                {section.steps.map((step, stepIndex) => (
                  <li key={stepIndex} className="flex gap-3 text-white/80">
                    <span className="backdrop-blur-md bg-white/20 border border-white/30 rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                      {stepIndex + 1}
                    </span>
                    <span>{step}</span>
                  </li>
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8">
          ...
          <div className="space-y-4 text-white/80">
            ...
            <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <p>Our catalog is fully responsive and optimized for mobile devices. Shop anywhere, anytime!</p>
            </div>
          </div>
